...
namespace wwwTest.Activities
{
    ...
    public class ActivitieEdit
    {
        ...
        [TestMethod]
        public void TheActivitieEditTest()
        {
            ...
            driver.FindElement(By.Id("gvMyActivities_btnEditActivity_0")).Click();
            driver.FindElement(By.Id("txtDistance")).Click();
            driver.FindElement(By.Id("txtDistance")).Clear();
            driver.FindElement(By.Id("txtDistance")).SendKeys("1500");
