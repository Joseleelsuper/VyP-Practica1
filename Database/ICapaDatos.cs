...
namespace Database
{
    internal interface ICapaDatos
    {
        ...
        /// <summary>
        /// OPCIONAL
        /// Retorna el número de usuarios registrados activos.
        /// </summary>
        /// <returns>Número de Usuarios.</returns>
        ...
        /// <returns>Verdadero o falso en función de si ha conseguido insertar/ actualizar la información.</returns>
        bool GuardaActividad(Activity e);
        ...
        Activity LeeActividad(int idElemento);
        ...
        bool EliminaUsuario(string email);

        bool EliminaActividad(int idActividad);
