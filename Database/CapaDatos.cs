...
namespace Database
{
    public class CapaDatos : ICapaDatos
    {
        ...
        public CapaDatos()
        {
            tblUsuarios.Add(new User("71478806G", "Juan", "Pérez", "juanp1025@alu.ubu.es", "HolaQ_123", 25, "644842590", Gender.MALE, 75.23f));
            tblUsuarios.Add(new User("46541439L", "María", "Gómez", "mariag1002@gmail.com", "AdiósQ_123", 18, "654655368", Gender.FEMALE, 57.1f));
            tblUsuarios.Add(new User("67177373P", "Admin", "Admin", "admin@admin.net", "AdminQ_123", 99, "644992132", Gender.HELICOPTERO_DE_COMBATE, 999999f) { Role = Role.ADMIN });
